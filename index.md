...
Crea un entorno virtual desde windows powershell
...
Uso del sistema
Ejecutar el servidor: python run.py

Ejecutar el cliente en otra terminal: python client/client.py
...
Ejecución del servidor. Api Funcionando Servidor Cliente
Registro de usuario Registro Exitoso Registro Exitoso Servidor
Inicio de sesión. Cliente Existente Contraseña Incorrecta Datos Validos Respuestas servidor
Creación de tarea. Crear tarea
Listado de tareas. Listar tareas Metodos servidor
...
. PR_PFO/ ├── app/ │ ├── init.py │ ├── models.py │ └── routes.py ├── client/ │ └── client.py ├── instance/ │ └── gestion_tareas.db ├── run.py ├── requirements.txt └── README.md
